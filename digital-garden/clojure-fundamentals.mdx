...
subtitle: "Integrating what I've learned so far"
image: ""
date: "2022-02-15"
---
...
Most literal expressions evaluate to themselves, except symbols and lists. Symbols are used to refer to something else and when evaluated, return what they refer to. Lists are evaluated as calls (see Operations below) 
